import { i as index_cjs, q as qodly_a0802e670d18cb83778a__mf_v__runtimeInit__mf_v__ } from './assets/qodly_a0802e670d18cb83778a__mf_v__runtimeInit__mf_v__-CbOscRFR.js';
import exposesMap from './assets/virtualExposes-ZqRix3zC.js';
import { _ as __vitePreload } from './assets/preload-helper-CqoC6PUU.js';

const importMap = {
      
        "react/jsx-runtime": async () => {
          let pkg = await __vitePreload(() => import('./assets/jsx-runtime-DIXFHocH.js').then(n => n.j),true              ?[]:void 0);
          return pkg
        }
      ,
        "react": async () => {
      ...
      ,
        "react-dom": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-Ne74M_Pn.js').then(n => n.i),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/webform-editor": async () => {
          let pkg = await __vitePreload(() => import('./assets/index.es-Dp1Pas48.js').then(n => n.i),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/craftjs-core": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-D8H--vnP.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/shared": async () => {
          let pkg = await __vitePreload(() => import('./assets/index.es-8HuBTSs4.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/craftjs-layers": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-Bor1FJ-o.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/craftjs-utils": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-DdoFC8oR.js'),true              ?[]:void 0);
          return pkg
        }
      ...
      const usedShared = {
          ...
          "react/jsx-runtime": {
            ...
            scope: ["default"],
            loaded: false,
            from: "qodly_a0802e670d18cb83778a",
            async get () {
...
const initTokens = {};
  ...
  const mfName = "qodly_a0802e670d18cb83778a";
  async function init(shared = {}, initScope = []) {
    ...
    qodly_a0802e670d18cb83778a__mf_v__runtimeInit__mf_v__.initResolve(initRes);
    return initRes
  }
